	...
	<div id="footer">
		<div class="inner_footer">
			...
			<div class="company">
				...
				신우경 <br> 주소 : 서울시 도산대로 16길 20, 이래빌딩 B1 ~ 4F <span class="bar">I</span>
				대표이사 : 신우경 <br> 입점문의 : <a href="#" target="_blank" class="link">입점문의하기</a>
				<span class="bar">I</span> 제휴문의 : <a href="#" class="link">business@kurlycorp.com</a>
				<br> 채용문의 : <a href="#" class="link">recruit@kurlycorp.com</a>
				<br> 팩스 : 070 - 7500 - 6098 <span class="bar">I</span> 이메일 : <a
					href="#" class="link">help@kurlycorp.com</a> <em class="copy">@
				...
				<ul class="list_sns">
					...
					<li><a
						href="https://www.youtube.com/channel/UCfpdjl5p1-1qKT7Xp4UQzQg"
